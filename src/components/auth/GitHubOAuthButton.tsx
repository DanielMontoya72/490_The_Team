...
export const GitHubOAuthButton = ({ mode }: GitHubOAuthButtonProps) => {
  const handleGitHubSignIn = () => {
    try {
      const clientId = 'Ov23liNh41mBCRbGWl16';
      ...
      toast.error(error.message || "Failed to initiate GitHub sign in");
    }
  };
