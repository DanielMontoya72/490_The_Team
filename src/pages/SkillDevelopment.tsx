...
import { BookOpen, TrendingUp, Target, Briefcase, AlertCircle, Plus, RefreshCw, Loader2, Brain, ChevronRight, Users, Code2, Clock } from "lucide-react";
        ...
        <aside className="lg:hidden fixed left-0 top-16 right-0 bg-card/80 backdrop-blur-md border-b z-40">
          <details className="group">
            ...
            <div className="px-4 pb-4 space-y-1 bg-card border-t">
              ...
              >
                <BookOpen className="h-4 w-4 text-primary transition-colors flex-shrink-0" />
                <span className="text-sm font-medium text-primary transition-colors truncate text-left leading-relaxed">Skills</span>
              </Link>
              <Link
                to="/career-goals"
                className="w-full flex items-center gap-2.5 px-2.5 py-3 rounded-lg hover:bg-muted/50 transition-colors group min-h-[40px]"
              ...
              <Link
                ...
                className="w-full flex items-center gap-2.5 px-2.5 py-3 rounded-lg hover:bg-muted/50 transition-colors group min-h-[40px]"
              >
                <Code2 className="h-4 w-4 text-white transition-colors flex-shrink-0" />
                <span className="text-sm font-medium text-white group-hover:text-primary transition-colors truncate text-left leading-relaxed">Technical Prep</span>
              </Link>
              <Link
